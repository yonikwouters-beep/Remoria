export const fr = {
  ...
  nav: {
    logoAria: "Page d'accueil Remoria",
    logoAlt: 'Remoria',
    mainAria: 'Navigation principale',
    mobileAria: 'Navigation mobile',
    home: 'Accueil',
    forWho: 'Pour qui ?',
    forBereaved: 'Pour les proches',
    forBereavedDesc: 'Conserver & partager les souvenirs',
    forFuneral: 'Pour le secteur funéraire',
    forFuneralDesc: 'Suivi et services numériques',
    about: 'À propos de Remoria',
    pricing: 'Tarifs',
    contact: 'Contact',
    login: 'Se connecter',
  ...
  footer: {
    logoAria: "Page d'accueil Remoria",
    logoAlt: 'Remoria',
    taglineLine1: 'Un espace pour les souvenirs',
    taglineLine2: 'qui durent.',
    productHeading: 'Produit',
    howItWorks: 'Comment ça marche ?',
    photoBook: 'Le livre photo',
    forWhoHeading: 'Pour qui ?',
    forBereaved: 'Pour les proches',
    forFuneral: 'Pour le secteur funéraire',
    aboutHeading: 'À propos de Remoria',
    aboutUs: 'Qui sommes-nous',
    contact: 'Contact',
    newsletterHeading: 'Restez informé',
    newsletterDesc: "Recevez des conseils et de l'inspiration pour chérir les souvenirs.",
    ...
    newsletterNoteAfter: '.',
    copyright: 'Remoria. Tous droits réservés.',
    vatAria: 'Numéro de TVA',
  ...
  guarantee: {
    text: 'Pas satisfait dans les 14 jours ? Remboursement complet — sans tracas',
  },
  ...
  uitvaartsector: {
    meta: {
      ...
      description:
        'Offrez aux familles un espace mémorial numérique serein dans le cadre de votre suivi. Portail gratuit, bénéfice fixe par plan, prêt en quelques secondes par dossier.',
    },
    hero: {
  ...
  overOns: {
    meta: {
      ...
      description:
        "Pourquoi Remoria existe : les plus belles photos et histoires n'atteignent souvent jamais la famille. Nous construisons l'endroit où elles arrivent — privé, serein et pour chaque génération.",
    },
    hero: {
    ...
    values: {
      ...
      cards: [
        ...
        },
        {
          ...
          desc: "Les souvenirs sont personnels et vulnérables. C'est pourquoi Remoria est entièrement fermé : seules les personnes que tu invites ont accès. Pas de publicités, pas de commerce de données, pas de compromis.",
        },
        {
          title: 'Le pont entre les générations',
  ...
  contact: {
    meta: {
      ...
      description: "Contacte Remoria. Nous sommes heureux de t'aider.",
    },
    hero: {
      eyebrow: 'Contact',
      title: 'Comment pouvons-nous t’aider ?',
      sub: "Une question sur un espace mémorial, besoin d'aide pour rassembler des souvenirs, ou simplement pour voir si Remoria vous convient ? Nous serions ravis d'avoir de tes nouvelles.",
      reassure: 'Nous répondons généralement sous un jour ouvrable',
    },
    info: {
      emailLabel: 'E-mail',
    ...
    faqTip: {
      before: "Besoin d'une réponse rapide sur les tarifs ou le renouvellement ? Consulte d'abord les ",
      link: 'questions fréquentes',
      after: '.',
    },
    form: {
      title: 'Envoie-nous un message',
      sub: 'Nous lisons chaque message personnellement.',
      naamLabel: 'Nom',
      ...
      berichtPlaceholder: "Comment pouvons-nous t'aider ? Écris librement avec tes propres mots.",
      submit: 'Envoyer le message →',
      privacy: 'Nous utilisons tes données uniquement pour te répondre',
      ...
      validationEmail: 'Saisis une adresse e-mail valide.',
    },
  },
} as const;
