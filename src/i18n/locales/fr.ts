export const fr = {
  ...
  contact: {
    ...
    hero: {
      eyebrow: 'Contact',
      titleLine1: 'Comment pouvons-',
      titleLine2: "nous t'aider ?",
      sub: "Tu as une question, tu veux collaborer ou simplement faire connaissance ? Nous serions ravis d'avoir de tes nouvelles.",
    },
    info: {
      emailLabel: 'E-mail',
      meetingLabel: 'Planifier un entretien',
      meetingDesc:
        'Tu es professionnel des pompes funèbres et tu veux découvrir Remoria ? Planifie une présentation sans engagement.',
    ...
    form: {
      ...
      afdelingLabel: 'Service',
      afdelingOptions: ['Général', 'Ventes', 'Support'],
