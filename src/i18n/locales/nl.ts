export const nl = {
  ...
  contact: {
    ...
    hero: {
      eyebrow: 'Contact',
      titleLine1: 'Hoe kunnen',
      titleLine2: 'we helpen?',
      sub: 'Heb je een vraag, wil je samenwerken of gewoon kennismaken? We horen graag van je.',
    },
    info: {
      emailLabel: 'E-mail',
      meetingLabel: 'Plan een gesprek',
      meetingDesc:
        'Ben je uitvaartprofessional en wil je Remoria ontdekken? Plan een vrijblijvende kennismaking.',
    ...
    form: {
      ...
      afdelingLabel: 'Afdeling',
      afdelingOptions: ['Algemeen', 'Sales', 'Support'],
